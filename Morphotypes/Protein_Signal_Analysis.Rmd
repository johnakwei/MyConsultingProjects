...
geom_point(aes(data_protein$a)) +
ggtitle("Protein - Signal 'a' Correlation") +
xlab("a") + ylab("a") +
...
geom_vline(xintercept=median(st$conf), col="#FF4500") +
annotate("text", x=c(sdLines[2],
                     sdLines[1], median(st$conf),
                     mLine), y=c(25, 25, 30, 25),
         label=c("SD Low", "SD High", "95% Conf", "Mean")) +
...
geom_point(aes(highValues$a)) +
ggtitle("High 'a' Values Correlation") +
xlab("'a' Values > 0.7") + ylab("'a' Values > 0.7") +
...
geom_vline(xintercept=median(stHigh$conf), col="#FF4500") +
annotate("text", x=c(sdLinesHigh[2],
                     sdLinesHigh[1], median(st$conf),
                     mLine), y=c(25, 25, 30, 25),
         label=c("SD Low", "SD High", "95% Conf", "Mean")) +
theme(plot.title=element_text(color="blue")) +
theme(axis.title=element_text(color="darkblue")) +
...
# Low 'a' Values Graph
ggplot(lowValues,
       aes(x=as.factor(lowValues$a), y=lowValues$a)) + 
geom_point(aes(lowValues$a)) +
ggtitle("Low 'a' Values Correlation") +
xlab("'a' Values < 0.7") + ylab("'a' Values < 0.7") +
...
geom_vline(xintercept=median(stLow$conf), col="#FF4500") +
annotate("text", x=c(sdLinesLow[2],
                     sdLinesLow[1], median(st$conf),
                     mLine), y=c(25, 25, 30, 25),
         label=c("SD Low", "SD High", "95% Conf", "Mean")) +
theme(plot.title=element_text(color="blue")) +
theme(axis.title=element_text(color="darkblue")) +
